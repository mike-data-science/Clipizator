# Vendored from fralapo/clippyme (MIT) — src/clippyme/pipeline/reframe_ops.py
# Pure-numpy crop-path smoothing math. See VENDORED-LICENSES.md.
# Upstream: https://github.com/fralapo/clippyme
